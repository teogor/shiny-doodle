...
export const glass = {
  subtle: { blur: 12, opacity: 0.76 },
  standard: { blur: 24, opacity: 0.68 },
  strong: { blur: 40, opacity: 0.56 },
} as const;

export const opticalClasses = [
  'heavy-frosted-shell',
  'recessed-inner-glass',
  'liquid-gloss-sheen',
  'opaque-shield',
] as const;

export type GlassVariant = keyof typeof glass;
export type OpticalClass = (typeof opticalClasses)[number];
